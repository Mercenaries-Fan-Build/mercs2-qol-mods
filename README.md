...
| [loadmarkers](mods/loadmarkers/) | Example: surfaces world-load progress and fires when the player is actually in-game, without `PMC_VERBOSE_LOG`. A template for reacting to load state via `m2_loghook` / `m2_loadtrigger`. |
